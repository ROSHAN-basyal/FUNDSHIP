...
try{
  ...
  await api('/auth/set-mpin',u7,'POST',{newMpin:'7788'});onboarding=await api('/bootstrap',u7);assert(onboarding.user.hasMpin,'Initial MPIN was not saved');await login('BT-007','private-beta-88');
